 ...
 */
public class Game_Contagem extends javax.swing.JFrame {
...
// NOVO    
    public void Iniciar(Game_Contagem gameWindow, Jogos jogo, Publico publico, Player player, Vector<ConjuntoImagem> conjuntosDeTrabalho,int indexFase, int indexNivel) throws IOException, InterruptedException{
        try{
...
//            System.out.println("01J: " + jogo.getNome() + " Pu: " + publico.getNome() + " Pl: " + player.getNome() + " CIT:" + conjuntosDeTrabalho.size() + " F:" + indexFase + " N:" + indexNivel);
    ...
    class WebcamFeed implements Runnable{
        ...
        private Game_Contagem gamewindow;
        private Game_Contagem gameWindow;
        private Jogos jogo;
        ...
        public WebcamFeed(Game_Contagem gameWindowParametro, Jogos jogo, Publico publico, Player player, Vector<ConjuntoImagem> conjuntosDeTrabalho,int indexFase, int indexNivel){
...
//                                    }
            ...
            try {
                ...
                Logger.getLogger(Game_Contagem.class.getName()).log(Level.SEVERE, null, ex);
            }
